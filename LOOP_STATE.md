...
- [ ] W200 Named test locks adapter whitespace-text-with-fields sentence
...
- W200: Named test locks the adapter sentence that whitespace-only JSONL `text` with `fields` uses the fields body.
