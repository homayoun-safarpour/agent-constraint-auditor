...
- [ ] W225 Refresh `docs/DAILY_LEARN.md` for JSONL `fields` keys stringify
...
- W225: Refresh `docs/DAILY_LEARN.md` for JSONL `fields` keys stringify.
- Why: parser + adapter + lock + pytest 117 + CI + MATRIX are named; hire-doc ladder next is DAILY_LEARN. Do not spray boolean field types. Do not pytest-lock DAILY_LEARN.
