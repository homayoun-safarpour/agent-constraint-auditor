...
- [ ] W307 Refresh BENCHMARK GATE CI tip to the latest green Actions run on main
...
- W307: Refresh BENCHMARK GATE CI tip to the latest green Actions run on main.
- Why: gate row still names `8c58f52` / run 35141810401 from before the trailing-whitespace PRs. Do not spray boolean field types. Do not pytest-lock DAILY_LEARN.
