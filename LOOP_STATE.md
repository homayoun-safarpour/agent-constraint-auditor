...
- [ ] W179 Refresh BENCHMARK GATE CI tip to the latest green Actions run on main
...
- W179: Refresh BENCHMARK GATE CI tip to the latest green Actions run on main after W177/W178.
- Why: named-claim pytest is 105 on main; the gate still cites `015d068`.
