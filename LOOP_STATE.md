...
- [ ] W237 Refresh BENCHMARK GATE CI tip to the latest green Actions run on main
...
- W237: Refresh BENCHMARK GATE CI tip to the latest green Actions run on main.
- Why: gate row still names `ef6c672` / run 35133139744 from before the list-fields PRs. Do not spray boolean field types.
