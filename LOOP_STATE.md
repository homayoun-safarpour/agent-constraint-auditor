...
| 2 | Named claim tests | PASS — `pytest` 107 passed; `ruff check .` clean (2026-09-16 W186) |
...
- [ ] W192 Refresh BENCHMARK GATE pytest count to 109
...
- W192: Refresh BENCHMARK GATE named-claim pytest count to 109.
- Why: W191 added two CLI tests; the gate still says 107.
