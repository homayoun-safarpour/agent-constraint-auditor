...
- [ ] W265 Refresh BENCHMARK GATE CI tip to the latest green Actions run on main
...
- W265: Refresh BENCHMARK GATE CI tip to the latest green Actions run on main.
- Why: gate row still names `f5fc2ca` / run 35136512223 from before the whitespace-value PRs. Do not spray boolean field types.
