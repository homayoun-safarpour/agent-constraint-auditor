...
| `1` | ERROR | Bad args / missing files / invalid spec / invalid regex / empty or headerless transcript / dated journal heading with no body / invalid or empty JSONL / JSONL object missing timestamp / JSONL timestamp not `YYYY-MM-DD HH:MM` / JSONL object missing text and fields |
