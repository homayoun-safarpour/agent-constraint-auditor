...
def test_parse_jsonl_object_line_with_trailing_comma_is_transcript_error(tmp_path):
    path = tmp_path / "events.jsonl"
    path.write_text(
        '{"timestamp": "2026-08-11 09:00", "text": "- gates: lint=PASS",}\n',
        encoding="utf-8",
...
def test_parse_jsonl_object_line_with_single_quoted_strings_is_transcript_error(tmp_path):
    path = tmp_path / "events.jsonl"
    path.write_text(
        "{'timestamp': '2026-08-11 09:00', 'text': '- gates: lint=PASS'}\n",
        encoding="utf-8",
...
def test_parse_jsonl_object_line_with_unquoted_keys_is_transcript_error(tmp_path):
    path = tmp_path / "events.jsonl"
    path.write_text(
        '{timestamp: "2026-08-11 09:00", text: "- gates: lint=PASS"}\n',
        encoding="utf-8",
...
def test_parse_jsonl_object_line_with_unquoted_string_values_is_transcript_error(tmp_path):
    path = tmp_path / "events.jsonl"
    path.write_text(
        '{"timestamp": "2026-08-11 09:00", "text": gates}\n',
        encoding="utf-8",
    )
    with pytest.raises(TranscriptError, match="invalid JSONL"):
        parse_jsonl_transcript(path)
...
def test_parse_jsonl_object_line_missing_comma_between_members_is_transcript_error(tmp_path):
    path = tmp_path / "events.jsonl"
    path.write_text(
        '{"timestamp": "2026-08-11 09:00" "text": "- gates: lint=PASS"}\n',
        encoding="utf-8",
...
def test_parse_jsonl_object_line_with_leading_non_whitespace_is_transcript_error(tmp_path):
    path = tmp_path / "events.jsonl"
    path.write_text(
        'extra {"timestamp": "2026-08-11 09:00", "text": "- gates: lint=PASS"}\n',
        encoding="utf-8",
    )
    with pytest.raises(TranscriptError, match="invalid JSONL"):
        parse_jsonl_transcript(path)
...
def test_parse_jsonl_hash_comment_line_is_transcript_error(tmp_path):
    path = tmp_path / "events.jsonl"
    path.write_text(
        '{"timestamp": "2026-08-11 09:00", "text": "- gates: a"}\n'
        "# note\n"
